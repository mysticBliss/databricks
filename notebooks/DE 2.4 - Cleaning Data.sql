...
-- ## Notes - max(email) gives the email; (max is just a hack)
-- ============================
-- select user_id, count(email) from users_dirty 
-- GROUP BY user_id
-- HAVING count(email) > 1;

-- select user_id, max(email) from users_dirty
-- WHERE user_id = "UA000000107363722"
-- GROUP BY user_id

-- user_id	          max(email)
-- UA000000107363722	tmiller67@yahoo.com
